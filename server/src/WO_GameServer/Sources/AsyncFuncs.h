...
class CJobBanChatUser : public CAsyncApiJob//AlexRedd:: Ban chat
{
public:
	int		isPermaBan;
	char		BanReason[256];	
...
class CJobAddLogInfo : public CAsyncApiJob //TradeGD
{
  public:
...
class CJobAddLogTradeInfo : public CAsyncApiJob
{
  public:
	DWORD		IP;
...
class CJobUpdateGameServerStatus : public CAsyncApiJob
{
  public:
	int			Status;
	int			Players;
  ...
  public:
	...
	int		Exec();
	void		OnSuccess() {r3dOutToLog("CJobUpdateGameServerStatus success\n");}
};
//
...
class CJobExchangeAdd : public CAsyncApiJob
{
public:
	int ItemID;
	...
	int ExchangeResultCode;
	int ExchangeShowInHUD;
