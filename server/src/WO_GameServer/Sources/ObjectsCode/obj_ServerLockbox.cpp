...
BOOL obj_ServerLockbox::OnCreate()
{
	...
	else if(m_ItemID == WeaponConfig::ITEMID_LockboxGALAX)
	{
		FileName = "Data\\ObjectsDepot\\Weapons\\item_lockbox_01_galax.sco";
		bsize    = r3dPoint3D(1.0900440f, 1.2519419f, 0.79267800f);
	}
	else if(m_ItemID == WeaponConfig::ITEMID_LockboxTM)
	{
		FileName = "Data\\ObjectsDepot\\Weapons\\Item_Lockbox_01_TM.sco";
		bsize    = r3dPoint3D(1.0900440f, 1.2519419f, 0.79267800f);
	}
	else if(m_ItemID == WeaponConfig::ITEMID_LockboxTT)
	{
		FileName = "Data\\ObjectsDepot\\Weapons\\Item_Lockbox_01_TT.sco";
		bsize    = r3dPoint3D(1.0900440f, 1.2519419f, 0.79267800f);
	}
	else if(m_ItemID == WeaponConfig::ITEMID_LockboxNKS)
	{
		FileName = "Data\\ObjectsDepot\\Weapons\\nksitem_lockbox_01_DB.sco";
		bsize    = r3dPoint3D(1.0900440f, 1.2519419f, 0.79267800f);
	}
	else if(m_ItemID == WeaponConfig::ITEMID_LockboxDELL)
	{
		FileName = "Data\\ObjectsDepot\\Weapons\\item_lockbox_01_dell.sco";
		bsize    = r3dPoint3D(1.0900440f, 1.2519419f, 0.79267800f);
	}
	else if(m_ItemID == WeaponConfig::ITEMID_LockboxREDBULL)
	{
		FileName = "Data\\ObjectsDepot\\Weapons\\item_lockbox_01_rb.sco";
		bsize    = r3dPoint3D(1.0900440f, 1.2519419f, 0.79267800f);
	}
	else if(m_ItemID == WeaponConfig::ITEMID_LockboxGIG)
	{
		FileName = "Data\\ObjectsDepot\\Weapons\\item_lockbox_01_gig.sco";
		bsize    = r3dPoint3D(1.0900440f, 1.2519419f, 0.79267800f);
	}
	else if(m_ItemID == WeaponConfig::ITEMID_LockboxARE)
	{
		FileName = "Data\\ObjectsDepot\\Weapons\\item_lockbox_01_are.sco";
		bsize    = r3dPoint3D(1.0900440f, 1.2519419f, 0.79267800f);
	}
	else if(m_ItemID == WeaponConfig::ITEMID_LockboxPIG)
	{
		FileName = "Data\\ObjectsDepot\\Weapons\\item_pig_safe.sco";
		bsize    = r3dPoint3D(1.0900440f, 1.2519419f, 0.79267800f);
	}
	else if(m_ItemID == WeaponConfig::ITEMID_LockboxArmy)
	{
		FileName = "Data\\ObjectsDepot\\Weapons\\item_lockarmy_01.sco";
		bsize    = r3dPoint3D(1.0900440f, 1.2519419f, 0.79267800f);
	}
	else
