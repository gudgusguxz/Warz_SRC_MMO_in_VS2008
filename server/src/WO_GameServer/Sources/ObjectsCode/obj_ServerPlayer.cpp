...
float obj_ServerPlayer::ReduceDamageByGear(int bodyPart, float damage)
{
	...
	//if(gslot == SLOT_Headgear && u_GetRandom(0, 100) < gc->m_bulkiness && !wasDisconnected_) //�ԧ������ǡ��
	//{
...
void obj_ServerPlayer::OnNetPacket(const PKT_C2C_PlayerReadyGrenade_s& n)
{
	...
	//if(loadout_->Items[n.wid].itemID == 596168 && gServerLogic.ginfo_.mapId != GBGameInfo::MAPID_WZ_Colorado){ //��ҹ���������������
