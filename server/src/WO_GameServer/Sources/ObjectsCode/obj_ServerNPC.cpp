...
IMPLEMENT_CLASS(obj_ServerCraftingNew, "obj_CraftingNew", "Object");
AUTOREGISTER_CLASS(obj_ServerCraftingNew);
...
obj_ServerCraftingNew::obj_ServerCraftingNew() 
{
}
...
BOOL obj_ServerCraftingNew::OnCreate()
{
	parent::OnCreate();
