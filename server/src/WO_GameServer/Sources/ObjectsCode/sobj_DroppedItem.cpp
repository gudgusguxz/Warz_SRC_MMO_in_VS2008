...
const float NODROPPED_ITEM_EXPIRE_TIME = 1.0f; //NARA::Nodrop
...
obj_DroppedItem::obj_DroppedItem()
{
    ...
    {
		srvObjParams_.ExpireTime = r3dGetTime() + NODROPPED_ITEM_EXPIRE_TIME; // setup here, as it can be overwritten
	}
	else
	{
