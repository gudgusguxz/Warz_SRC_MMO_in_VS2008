...
void PlayGameServer()
{
  ...
  switch(gServerLogic.ginfo_.mapId) 
  {
	...
	case GBGameInfo::MAPID_WZ_AircraftCarrier: 
      r3dGameLevel::SetHomeDir("WZ_AircraftCarrier"); 
      break;
	case GBGameInfo::MAPID_WZ_Trade_Map: 
      r3dGameLevel::SetHomeDir("WZ_Trade"); 
      break;

/////////////////////////////////////////

	case GBGameInfo::MAPID_PVP01:
	  r3dGameLevel::SetHomeDir("WZ_Clearview"); 
	  break;
	case GBGameInfo::MAPID_PVP02:
	  r3dGameLevel::SetHomeDir("WZ_Rockyford"); 
	  break;
	case GBGameInfo::MAPID_PVP03:
	  r3dGameLevel::SetHomeDir("WZ_Bigcity"); 
	  break;
	case GBGameInfo::MAPID_PVP04:
	  r3dGameLevel::SetHomeDir("WZ_Sesamo"); 
	  break;
	case GBGameInfo::MAPID_PVP05:
	  r3dGameLevel::SetHomeDir("WZ_Market"); 
	  break;
	case GBGameInfo::MAPID_PVP06:
	  r3dGameLevel::SetHomeDir("WZ_MarketNodrop"); 
	  break;
	case GBGameInfo::MAPID_PVP07:
	  r3dGameLevel::SetHomeDir("WZ_Container"); 
	  break;
	case GBGameInfo::MAPID_PVP08:
	  r3dGameLevel::SetHomeDir("WZ_Snowvillage"); 
	  break;
	case GBGameInfo::MAPID_PVP09:
	  r3dGameLevel::SetHomeDir("WZ_Ecosnow"); 
	  break;
	case GBGameInfo::MAPID_PVP10:
	  r3dGameLevel::SetHomeDir("WZ_Paintball"); 
	  break;
	case GBGameInfo::MAPID_PVP11:
	  r3dGameLevel::SetHomeDir("WZ_Bunker"); 
	  break;
	case GBGameInfo::MAPID_PVP12:
	  r3dGameLevel::SetHomeDir("WZ_RockyfordV2"); 
	  break;
	case GBGameInfo::MAPID_PVP13:
	  r3dGameLevel::SetHomeDir("WZ_Lego"); 
	  break;
	case GBGameInfo::MAPID_PVP14:
	  r3dGameLevel::SetHomeDir("WZ_ClearviewOrg"); 
	  break;
	case GBGameInfo::MAPID_PVP15:
	  r3dGameLevel::SetHomeDir("WZ_RockyfordOrg"); 
	  break;

	case GBGameInfo::MAPID_PVP16:
	  r3dGameLevel::SetHomeDir("WZ_Frosty"); 
	  break;
	case GBGameInfo::MAPID_PVP17:
	  r3dGameLevel::SetHomeDir("PVP17"); 
	  break;
	case GBGameInfo::MAPID_PVP18:
	  r3dGameLevel::SetHomeDir("PVP18"); 
	  break;
	case GBGameInfo::MAPID_PVP19:
	  r3dGameLevel::SetHomeDir("PVP19"); 
	  break;
	case GBGameInfo::MAPID_PVP20:
	  r3dGameLevel::SetHomeDir("PVP20");
	  break;
	case GBGameInfo::MAPID_PVP21:
	  r3dGameLevel::SetHomeDir("PVP21"); 
	  break;
	case GBGameInfo::MAPID_PVP22:
	  r3dGameLevel::SetHomeDir("PVP22"); 
	  break;
	case GBGameInfo::MAPID_PVP23:
	  r3dGameLevel::SetHomeDir("PVP23"); 
	  break;
	case GBGameInfo::MAPID_PVP24:
	  r3dGameLevel::SetHomeDir("PVP24"); 
	  break;
	case GBGameInfo::MAPID_PVP25:
	  r3dGameLevel::SetHomeDir("PVP25"); 
	  break;
}
  ...
  {
	  if (gServerLogic.ginfo_.flags & GBGameInfo::SFLAGS_DisableASR)
	  {
		  //r3dOutToLog( "!!! Strarting preload Dev items\n");
		  gServerLogic.PreloadDevEventLoadoutSnipersMode();// Sniper Mode
	  }
	  else if (gServerLogic.ginfo_.flags & GBGameInfo::SFLAGS_DisableSNP)
	  {
		  //r3dOutToLog( "!!! Strarting preload Dev items2\n");
		  gServerLogic.PreloadDevEventLoadoutNoSnipersMode(); // No Sniper Mode
	  }
	  else
  ...
  while(1) 
  {
	  ...
	  //if(timeServerTick+timeGameworldUpdate+timeTerrain3Update+timePhysXUpdate+timeNavmeshUpdate>0.09f) //TOEiX2TEST
	  //{
