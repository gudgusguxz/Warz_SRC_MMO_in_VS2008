...
{	
	...
	else if (CreateParams.vehicleType == VEHICLETYPE_SCOUTMILITARY)
		damageMesh = r3dGOBAddMesh("Data\\ObjectsDepot\\Vehicles\\Scout_Military_dmg.sco");
	else if (CreateParams.vehicleType == VEHICLETYPE_BUGGYGUN)
		damageMesh = r3dGOBAddMesh("Data\\ObjectsDepot\\Vehicles\\BuggyGun_crash.sco");
	else if (CreateParams.vehicleType == VEHICLETYPE_SCOUTSURVIVOR)
		damageMesh = r3dGOBAddMesh("Data\\ObjectsDepot\\Vehicles\\Scout_Survivor_dmg.sco");
	else if (CreateParams.vehicleType == VEHICLETYPE_BONECRUSHER)
		damageMesh = r3dGOBAddMesh("Data\\ObjectsDepot\\Vehicles\\BoneCrusher_DMG.sco");
	else if (CreateParams.vehicleType == VEHICLETYPE_SCAVENGERSSCOUT)
		damageMesh = r3dGOBAddMesh("Data\\ObjectsDepot\\Vehicles\\Scavengers_Scout_DMG.sco");
...
BOOL obj_Vehicle::CreateForEditor()
{
	...
	else if (m->FileName == "data/objectsdepot/vehicles/Scout_Military.sco")
		CreateParams.vehicleType = VEHICLETYPE_SCOUTMILITARY;
	else if (m->FileName == "data/objectsdepot/vehicles/BuggyGun.sco")
		CreateParams.vehicleType = VEHICLETYPE_BUGGYGUN;
	else if (m->FileName == "data/objectsdepot/vehicles/Scout_Survivor.sco")
		CreateParams.vehicleType = VEHICLETYPE_SCOUTSURVIVOR;
	else if (m->FileName == "data/objectsdepot/vehicles/BoneCrusher.sco")
		CreateParams.vehicleType = VEHICLETYPE_BONECRUSHER;
	else if (m->FileName == "data/objectsdepot/vehicles/Scavengers_Scout.sco")
		CreateParams.vehicleType = VEHICLETYPE_SCAVENGERSSCOUT;
...
void obj_Vehicle::SetupBoxObstacle()
{
	...
	if (CreateParams.vehicleType == VEHICLETYPE_BUGGY)
		...
		obstacle.mHalfExtents = PxVec3(1.8f, 2.0f, 2.8f);
	else if (CreateParams.vehicleType == VEHICLETYPE_BUGGYGUN)
		obstacle.mHalfExtents = PxVec3(1.8f, 2.2f, 3.0f);
	else if (CreateParams.vehicleType == VEHICLETYPE_SCOUTSURVIVOR)
		obstacle.mHalfExtents = PxVec3(1.6f, 2.0f, 2.8f);
	else if (CreateParams.vehicleType == VEHICLETYPE_BONECRUSHER)
		obstacle.mHalfExtents = PxVec3(2.0f, 2.2f, 3.3f);
	else if (CreateParams.vehicleType == VEHICLETYPE_SCAVENGERSSCOUT)
		obstacle.mHalfExtents = PxVec3(1.8f, 2.2f, 3.0f);
	else if (CreateParams.vehicleType == VEHICLETYPE_TANK_T80)
		obstacle.mHalfExtents = PxVec3(2.1f, 2.2f, 3.3f);
...
{
	if (CreateParams.vehicleType == VEHICLETYPE_BUGGY || CreateParams.vehicleType == VEHICLETYPE_BUGGYGUN)
	{
		sndEngineStartId = SoundSys.GetEventIDByPath("Sounds/Vehicles/DuneBuggy/DuneBuggyEngine_Start");	
		sndEngineStopId = SoundSys.GetEventIDByPath("Sounds/Vehicles/DuneBuggy/DuneBuggyEngine_Stop");
		sndEngineId = SoundSys.GetEventIDByPath("Sounds/Vehicles/DuneBuggy/DuneBuggyEngineLoop");
	}
	else if (CreateParams.vehicleType == VEHICLETYPE_STRYKER || CreateParams.vehicleType == VEHICLETYPE_ZOMBIEKILLER ||
			 CreateParams.vehicleType == VEHICLETYPE_TANK_T80)
	{
		sndEngineStartId = SoundSys.GetEventIDByPath("Sounds/Vehicles/Stryker/StrykerEngine_Start");	
		sndEngineStopId = SoundSys.GetEventIDByPath("Sounds/Vehicles/Stryker/StrykerEngine_Stop");
		sndEngineId = SoundSys.GetEventIDByPath("Sounds/Vehicles/Stryker/StrykerEngineLoop");
	}
	else if (CreateParams.vehicleType == VEHICLETYPE_SCOUTMILITARY)
	{
		sndEngineStartId = SoundSys.GetEventIDByPath("Sounds/Vehicles/GroceryGetter/GroceryGetterEngine_Start");	
		sndEngineStopId = SoundSys.GetEventIDByPath("Sounds/Vehicles/GroceryGetter/GroceryGetterEngine_Stop");
		sndEngineId = SoundSys.GetEventIDByPath("Sounds/Vehicles/GroceryGetter/GroceryGetterEngineLoop");
	}
	else if (CreateParams.vehicleType == VEHICLETYPE_SCOUTSURVIVOR)
	{
		sndEngineStartId = SoundSys.GetEventIDByPath("Sounds/Vehicles/CopCar/CopCarEngine_Start");	
		sndEngineStopId = SoundSys.GetEventIDByPath("Sounds/Vehicles/CopCar/CopCarEngine_Stop");
		sndEngineId = SoundSys.GetEventIDByPath("Sounds/Vehicles/CopCar/CopCarEngineLoop");
	}
	else if (CreateParams.vehicleType == VEHICLETYPE_SCAVENGERSSCOUT)
	{
		sndEngineStartId = SoundSys.GetEventIDByPath("Sounds/Vehicles/HEMTT/HEMTTEngine_Start");	
		sndEngineStopId = SoundSys.GetEventIDByPath("Sounds/Vehicles/HEMTT/HEMTTEngine_Stop");
		sndEngineId = SoundSys.GetEventIDByPath("Sounds/Vehicles/HEMTT/HEMTTEngineLoop");
	}
	else if (CreateParams.vehicleType == VEHICLETYPE_BONECRUSHER)
	{
		sndEngineStartId = SoundSys.GetEventIDByPath("Sounds/Vehicles/BoneCrusher/BoneCrusherEngine_Start");	
		sndEngineStopId = SoundSys.GetEventIDByPath("Sounds/Vehicles/BoneCrusher/BoneCrusherEngine_Stop");
		sndEngineId = SoundSys.GetEventIDByPath("Sounds/Vehicles/BoneCrusher/BoneCrusherEngineLoop");
	}
...
void obj_Vehicle::CheckInput()
{
	if(NetworkLocal)
	{
		...
		if (hudMain && (hudMain->isChatInputActive() || hudMain->isPlayersListVisible() || hudMain->isTauntVisible())) return;
	...
	if (player->NetworkLocal)
	{
		...
		if (!g_bEditMode)
		{
			...
			if (CreateParams.vehicleType == VEHICLETYPE_BUGGY)
				...
				hudMain->setCarTypeInfo("crusher");
			else if (CreateParams.vehicleType == VEHICLETYPE_SCOUTSURVIVOR)
				hudMain->setCarTypeInfo("cop");
			else if (CreateParams.vehicleType == VEHICLETYPE_SCOUTMILITARY)
				hudMain->setCarTypeInfo("military");
			else if (CreateParams.vehicleType == VEHICLETYPE_SCAVENGERSSCOUT)
				hudMain->setCarTypeInfo("military");
