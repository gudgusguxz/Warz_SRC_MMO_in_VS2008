...
class CUberAnim
{
...
#endif
	void		SwitchToState(int PlayerState, int MoveDir, int AnglingStatus = 0);
  ...
  public:
	...
	void        SyncAnimation(int PlayerState, int MoveDir, bool force, const Weapon* weap, bool isInAttmMenu, int AnglingStatus = 0, bool isWantingToInspect = false);
