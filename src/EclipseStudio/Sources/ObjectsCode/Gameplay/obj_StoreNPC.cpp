...
IMPLEMENT_CLASS(obj_SellNPC, "obj_SellNPC", "Object");
AUTOREGISTER_CLASS(obj_SellNPC);
IMPLEMENT_CLASS(obj_SellGCNPC, "obj_SellGCNPC", "Object");
AUTOREGISTER_CLASS(obj_SellGCNPC);
IMPLEMENT_CLASS(obj_CraftingNew, "obj_CraftingNew", "Object");
AUTOREGISTER_CLASS(obj_CraftingNew);
IMPLEMENT_CLASS(obj_ExchangeNPC, "obj_ExchangeNPC", "Object");
AUTOREGISTER_CLASS(obj_ExchangeNPC);
...
obj_SellNPC::obj_SellNPC() : obj_BaseNPC()
{
	m_ActionUI_Title = gLangMngr.getString("ActionUI_SellTitle");
	m_ActionUI_Msg = gLangMngr.getString("HoldEToAccessSell");	
	m_NPCMeshName = "gang_technician_NPC";
	m_NPCAnimName = "Civ_Idle_03";
}

obj_SellGCNPC::obj_SellGCNPC() : obj_BaseNPC()
{
	m_ActionUI_Title = gLangMngr.getString("ActionUI_SellGCTitle");
	m_ActionUI_Msg = gLangMngr.getString("HoldEToAccessSellGC");	
	m_NPCMeshName = "gang_technician_NPC";
	m_NPCAnimName = "Civ_Idle_03";
}

obj_CraftingNew::obj_CraftingNew() : obj_BaseNPC()
{
	m_ActionUI_Title = gLangMngr.getString("ActionUI_CraftingTitle");
	m_ActionUI_Msg = gLangMngr.getString("HoldEToAccessCrafting");
	m_NPCMeshName = "1_Space_Blue";
	m_NPCAnimName = "1_Space_Blue";
}

obj_ExchangeNPC::obj_ExchangeNPC() : obj_BaseNPC()
{
	m_ActionUI_Title = gLangMngr.getString("ActionUI_ExchangeTitle");
	m_ActionUI_Msg = gLangMngr.getString("HoldEToAccessExchange");
	m_NPCMeshName = "1_Space_Blue";
	m_NPCAnimName = "1_Space_Blue";
}