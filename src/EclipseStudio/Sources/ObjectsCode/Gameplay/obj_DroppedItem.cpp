...
void obj_DroppedItem::AppendRenderables( RenderArray ( & render_arrays )[ rsCount ], const r3dCamera& Cam )
{
	...
	if (GetHighlight())
	{		//AlexRedd:: for new opt
		MeshObjDeferredHighlightRenderable rend;
		if (r_highlight_mode->GetInt() == 0)
			rend.Init(MeshGameObject::GetObjectLodMesh(), this, r3dColor::blue.GetPacked());
		else if (r_highlight_mode->GetInt() == 1)
			rend.Init(MeshGameObject::GetObjectLodMesh(), this, r3dColor::green.GetPacked());
		else if (r_highlight_mode->GetInt() == 2)
			rend.Init(MeshGameObject::GetObjectLodMesh(), this, r3dColor::grey.GetPacked());
		else if (r_highlight_mode->GetInt() == 3)
			rend.Init(MeshGameObject::GetObjectLodMesh(), this, r3dColor::orange.GetPacked());
		else if (r_highlight_mode->GetInt() == 4)
			rend.Init(MeshGameObject::GetObjectLodMesh(), this, r3dColor::red.GetPacked());
		else if (r_highlight_mode->GetInt() == 5)
			rend.Init(MeshGameObject::GetObjectLodMesh(), this, r3dColor::white.GetPacked());
		else if (r_highlight_mode->GetInt() == 6)
