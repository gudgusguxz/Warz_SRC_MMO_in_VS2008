...
private:
	...
	void UpdateSounds();
	float m_bossHealth;//AlexRedd:: boss health
...
public:
	...
	bool		IsSuperZombie2() { return m_typeIndex == 1; }
	...
	void			OnNetPacket(const PKT_S2C_SZombieHealth_s& n);
...
public:
	...
	void DrawSZInfo() const;//AlexRedd:: boss health
