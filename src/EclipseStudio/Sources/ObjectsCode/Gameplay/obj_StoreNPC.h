...
class obj_SellNPC : public obj_BaseNPC
{
	DECLARE_CLASS(obj_SellNPC, obj_BaseNPC)
public:
	obj_SellNPC();
};

class obj_SellGCNPC : public obj_BaseNPC
{
	DECLARE_CLASS(obj_SellGCNPC, obj_BaseNPC)
public:
	obj_SellGCNPC();
};

class obj_CraftingNew : public obj_BaseNPC
{
	DECLARE_CLASS(obj_CraftingNew, obj_BaseNPC)
public:
	obj_CraftingNew();
};

class obj_ExchangeNPC : public obj_BaseNPC
{
	DECLARE_CLASS(obj_ExchangeNPC, obj_BaseNPC)
public:
	obj_ExchangeNPC();
};
