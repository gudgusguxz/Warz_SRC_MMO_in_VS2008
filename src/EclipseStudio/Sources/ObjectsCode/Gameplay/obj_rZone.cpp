...
namespace
{
	struct obj_RadioactiveAreaCompositeRenderable: public Renderable
	{
		...
		static void Draw( Renderable* RThis, const r3dCamera& Cam )
		{
			...
			r3dDrawLine3D(This->Parent->GetPosition(), This->Parent->GetPosition() + r3dPoint3D(0, 20.0f, 0), Cam, 0.4f, r3dColor24::red);
...
void obj_RadioactiveArea::CreateArea(float x,float y,float z)
{
	...
	m_RadiactiveArea = (obj_ParticleSystem*)srv_CreateGameObject("obj_ParticleSystem", "Env_Dust_04", r3dPoint3D(x,y,z) + r3dPoint3D(0, -1.0f, 0) );

}

BOOL obj_RadioactiveArea::Load(const char *fname)
{
	const char* cpMeshName = "Data\\ObjectsDepot\\WZ_RadioactiveProps\\Radioactiv_Barrel_2.sco";
