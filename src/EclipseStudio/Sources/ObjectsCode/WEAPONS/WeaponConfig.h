...
public:
	...
	enum EUsableItemIDs
	{
		...
		ITEMID_SpawnCra = 800124,

		ITEMID_FishingRod = 121001,
		ITEMID_FishingRod1 = 121002,
		ITEMID_FishingBait = 121003,
		ITEMID_FishingLoot = 321001,
		...
		ITEMID_LockboxGALAX = 800258,
		ITEMID_LockboxTM = 800003,
		ITEMID_LockboxTT = 800265,
		ITEMID_LockboxNKS = 102108,
		ITEMID_LockboxDELL = 800186,
		ITEMID_LockboxREDBULL = 811192,
		ITEMID_LockboxGIG = 811197,
		ITEMID_LockboxARE = 811198,
		ITEMID_LockboxPIG = 811209,
		ITEMID_LockboxArmy = 811210,
		//Lockbox

		//Boxrandom
		ITEMID_BOXRANDOM1  = 123451,
		ITEMID_BOXRANDOM2  = 123452,
		ITEMID_BOXRANDOM3  = 123453,
		ITEMID_BOXRANDOM4  = 123454,
		ITEMID_BOXRANDOM5  = 123455,
		ITEMID_BOXRANDOM6  = 123456,
		ITEMID_BOXRANDOM7  = 123457,
		ITEMID_BOXRANDOM8  = 123458,
		ITEMID_BOXRANDOM9  = 123459,
		ITEMID_BOXRANDOM10  = 123460,
		//Boxrandom Premium V1 - V3
		ITEMID_BOXRANDOM11  = 191901,
		ITEMID_BOXRANDOM12  = 191902,
		ITEMID_BOXRANDOM13  = 191903,
		...
		//RiotShield
		ITEMID_RiotShieldTM = 800002,
		ITEMID_RiotShieldGalax = 800173,
		ITEMID_RiotShieldJumper = 800178,
		//RiotShield
	...
	float	m_PremRepairAmount;
	int		m_RepairPriceGD;
	bool    m_effectDmgDance; // GUN CONTENT
  ...
  public:
	WeaponConfig(uint32_t id) : ModelItemConfig(id)
	{
		...
		m_PremRepairAmount = 0.0f;
		m_RepairPriceGD = 0;
		m_effectDmgDance = false; // GUN CONTENT
	}
