...
BOOL obj_Barricade::OnCreate()
{
	...
	else if(m_ItemID == WeaponConfig::ITEMID_RiotShieldTM)
		m_PrivateModel = r3dGOBAddMesh("Data\\ObjectsDepot\\Weapons\\item_riot_shield_01_tm.sco", true, false, true, true );
	else if(m_ItemID == WeaponConfig::ITEMID_RiotShieldGalax)
		m_PrivateModel = r3dGOBAddMesh("Data\\ObjectsDepot\\Weapons\\item_riot_shield_01_gal.sco", true, false, true, true );
	else if(m_ItemID == WeaponConfig::ITEMID_RiotShieldJumper)
		m_PrivateModel = r3dGOBAddMesh("Data\\ObjectsDepot\\Weapons\\item_riot_shield_01_galax.sco", true, false, true, true );
