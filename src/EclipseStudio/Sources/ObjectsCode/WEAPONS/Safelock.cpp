...
BOOL obj_Safelock::OnCreate()
{
	...
	if(m_ItemID == WeaponConfig::ITEMID_LockboxGALAX)
		cpMeshName = "Data\\ObjectsDepot\\Weapons\\item_lockbox_01_galax.sco";
	if(m_ItemID == WeaponConfig::ITEMID_LockboxTM)
		cpMeshName = "Data\\ObjectsDepot\\Weapons\\Item_Lockbox_01_TM.sco";
	if(m_ItemID == WeaponConfig::ITEMID_LockboxTT)
		cpMeshName = "Data\\ObjectsDepot\\Weapons\\Item_Lockbox_01_TT.sco";
	if(m_ItemID == WeaponConfig::ITEMID_LockboxNKS)
		cpMeshName = "Data\\ObjectsDepot\\Weapons\\nksitem_lockbox_01_DB.sco";
	if(m_ItemID == WeaponConfig::ITEMID_LockboxDELL)
		cpMeshName = "Data\\ObjectsDepot\\Weapons\\item_lockbox_01_dell.sco";
	if(m_ItemID == WeaponConfig::ITEMID_LockboxREDBULL)
		cpMeshName = "Data\\ObjectsDepot\\Weapons\\item_lockbox_01_rb.sco";
	if(m_ItemID == WeaponConfig::ITEMID_LockboxGIG)
		cpMeshName = "Data\\ObjectsDepot\\Weapons\\item_lockbox_01_gig.sco";
	if(m_ItemID == WeaponConfig::ITEMID_LockboxARE)
		cpMeshName = "Data\\ObjectsDepot\\Weapons\\item_lockbox_01_are.sco";
	if(m_ItemID == WeaponConfig::ITEMID_LockboxPIG)
		cpMeshName = "Data\\ObjectsDepot\\Weapons\\item_pig_safe.sco";
	if(m_ItemID == WeaponConfig::ITEMID_LockboxArmy)
		cpMeshName = "Data\\ObjectsDepot\\Weapons\\item_lockarmy_01.sco";
