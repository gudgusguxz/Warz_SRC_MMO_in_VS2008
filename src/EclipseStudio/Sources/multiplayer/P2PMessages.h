...
// !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
#define P2PNET_VERSION		(0x00000200 + GBWEAPINFO_VERSION + GBGAMEINFO_VERSION + GAMEPLAYPARAM_VERSION)
...
enum pkttype_e
{
  ...
  PKT_C2C_PlayerSwearing, //AlexRedd auto ban chat
  PKT_C2C_AddPlayerSwearsMsg,   //AlexRedd:: message for player swearing
  ...
  PKT_C2S_BackpackDropAll,		//AlexRedd:: drop all 
  ...
  PKT_C2S_OpenBoxReadyPlay,

  PKT_C2S_ExchangeItem,
  PKT_S2C_ExchangeItemAns,
...
//Edit by AMGuard
  ...
  // CraftingNew
  PKT_C2S_CraftingNewItem,
  PKT_S2C_CraftingNewItemAns,
  PKT_C2S_CraftingNewItemAdd,
  ...
  PKT_S2C_SZombieHealth,		//AlexRedd:: boss health
  ...
  PKT_C2S_ClientConnection,//AlexRedd:: Hight Ping
...
#endif
  PKT_C2S_addProtection,
  PKT_S2C_addProtectionAns,
  PKT_S2C_AnglingStatus,
  PKT_C2S_AnglingCancel,
  PKT_C2C_MarkerData,
...
struct PKT_C2S_SetRespawnData_s : public DefaultPacketMixin<PKT_C2S_SetRespawnData> //Respawnfast
{
...
struct PKT_S2C_CreateScenario_s : public DefaultPacketMixin<PKT_S2C_CreateScenario>
{
	gp2pnetid_t		spawnID;
	char			fname[512];
	r3dPoint3D		pos;
...
struct PKT_C2C_PlayerSwearing_s : public DefaultPacketMixin<PKT_C2C_PlayerSwearing>
{
...
struct PKT_C2C_Startinsult_s : public DefaultPacketMixin<PKT_C2C_Startinsult>
{
};
struct PKT_C2C_StartTalk_s : public DefaultPacketMixin<PKT_C2C_Startinsult>
{
};
...
//TradeGD
struct PKT_C2C_TradeGD_s : public DefaultPacketMixin<PKT_C2C_TradeGD>
{
	int	Gamedollars;
};

struct PKT_C2C_TradeGDAns_s : public DefaultPacketMixin<PKT_C2C_TradeGDAns>
{
	int		GamePoints;
	int		GameDollars;
};
...
struct PKT_C2S_CraftingNewItem_s : public DefaultPacketMixin<PKT_C2S_CraftingNewItem>
{
	uint32_t recordID;
};

struct PKT_S2C_CraftingNewItemAns_s : public DefaultPacketMixin<PKT_S2C_CraftingNewItemAns>
{
	BYTE ans;
	int Result;
};

struct PKT_C2S_CraftingNewItemAdd_s : public DefaultPacketMixin<PKT_C2S_CraftingNewItemAdd>
{
	uint32_t recordID;
	int Result;
};
...
struct PKT_C2S_ExchangeItem_s : public DefaultPacketMixin<PKT_C2S_ExchangeItem> 
{
	uint32_t recordID;
};

struct PKT_S2C_ExchangeItemAns_s : public DefaultPacketMixin<PKT_S2C_ExchangeItemAns> 
{
	enum Status
	{
		E_Failed,
...
struct PKT_S2C_CreateZombie_s : public DefaultPacketMixin<PKT_S2C_CreateZombie>
{
	...
	float		SZombieHealth;//AlexRedd:: boss health
};
...
struct PKT_S2C_KillPlayer_s : public DefaultPacketMixin<PKT_S2C_KillPlayer>
{
	...
	int			lastTimeHitItemID;
	int			KillFlag;//Kill mode
	int         Killstreak;//Killstreak
	char		victim[64];//Player dead
	char		killer[64];//Player killer
};
...
struct PKT_C2C_AddPlayerSwearsMsg_s : public DefaultPacketMixin<PKT_C2C_AddPlayerSwearsMsg>
{
	int		Count;	
};
...
struct PKT_C2S_ClientConnection_s : public DefaultPacketMixin<PKT_C2S_ClientConnection>//AlexRedd:: Hight Ping
{
	bool	isHightPing;
	//bool	isFirewallBehind;
...
struct PKT_C2C_MarkerData_s : public DefaultPacketMixin<PKT_C2C_MarkerData>
{
	BYTE id;
	r3dVector pos;
	char markerdetail[128 * 128];
};
...
struct PKT_S2C_AnglingStatus_s : public DefaultPacketMixin<PKT_S2C_AnglingStatus>
{
	BYTE AnglingStatus;
	uint32_t Fishrod_ItemID;
	uint32_t Reward_ItemID;
	uint32_t Bait_ItemID;
	int Bait_Qty;
};

struct PKT_C2S_AnglingCancel_s : public DefaultPacketMixin<PKT_C2S_AnglingCancel>
{	
};

struct PKT_C2S_OpenBoxReadyPlay_s : public DefaultPacketMixin<PKT_C2S_OpenBoxReadyPlay>
{
	BYTE		WeaponSlot;
};

struct PKT_C2S_addProtection_s : public DefaultPacketMixin<PKT_C2S_addProtection>
{
	gp2pnetid_t	PlayerID;
}; 

struct PKT_S2C_addProtectionAns_s : public DefaultPacketMixin<PKT_S2C_addProtectionAns>
{	
	float		spawnProtection;	
};

struct PKT_S2C_SZombieHealth_s : public DefaultPacketMixin<PKT_S2C_SZombieHealth>//AlexRedd:: boss health
{	
	float		SZombieHealth;
};
