...
static void DrawMenus()
{
	...
	*/
	...
	if (!win::bSuspended && !hudMain->isChatInputActive() && !hudMain->isPlayersListVisible() && !hudMain->isTauntVisible()/* && !plr->bDead*/)//�������ö�� I ������͵��
	{
...
void ProcessPlayerMovement(obj_Player* pl, bool editor_debug )
{
	...
	VMPROTECT_BeginMutation("ProcessPlayerMovement_Accel");	
	{
		...
		if(!disablePlayerMovement)
		{
			...
			if(pl->CurLoadout.HeroItemID == 20228 ) //����Ф������ #�����觷�
			accelaration *= 1.2f;
			if(pl->CurLoadout.HeroItemID == 20229 ) //����Ф������ #�����觷�
			accelaration *= 1.2f;
			if(pl->CurLoadout.HeroItemID == 20230 ) //����Ф������ #�����觷�
			accelaration *= 1.2f;
			if(pl->CurLoadout.HeroItemID == 20232 ) //����Ф������ #�����觷�
			accelaration *= 1.2f;
			if(pl->CurLoadout.HeroItemID == 20233 ) //����Ф������ #�����觷�
			accelaration *= 1.2f;
			if(pl->CurLoadout.HeroItemID == 20234 ) //����Ф������ #�����觷�
			accelaration *= 1.2f;

			if(pl->CurLoadout.HeroItemID == 20226 ) //����Ф������ #��50
			accelaration *= 1.2f;
			if(pl->CurLoadout.HeroItemID == 20255 ) //����Ф������ #��50
			accelaration *= 1.2f;
			if(pl->CurLoadout.HeroItemID == 20253 ) //����Ф������ #��50
			accelaration *= 1.2f;

			if(pl->CurLoadout.HeroItemID == 20225 ) //����Ф������ #3500GC
			accelaration *= 1.1f;
			if(pl->CurLoadout.HeroItemID == 20240 ) //����Ф������ #3500GC
			accelaration *= 1.1f;
			if(pl->CurLoadout.HeroItemID == 20241 ) //����Ф������ #3500GC
			accelaration *= 1.1f;
			if(pl->CurLoadout.HeroItemID == 20244 ) //����Ф������ #3500GC
			accelaration *= 1.1f;
			if(pl->CurLoadout.HeroItemID == 20245 ) //����Ф������ #3500GC
			accelaration *= 1.1f;
			if(pl->CurLoadout.HeroItemID == 20224 ) //����Ф������ #3500GC
			accelaration *= 1.1f;

			if(pl->CurLoadout.HeroItemID == 20222 ) //�Ԩ����
			accelaration *= 1.1f;
			if(pl->CurLoadout.HeroItemID == 20223 ) //�Ԩ����
			accelaration *= 1.1f;
			if(pl->CurLoadout.HeroItemID == 20212 ) //�Ԩ����
			accelaration *= 1.1f;


			if(pl->CurLoadout.HeroItemID == 20252 ) //����Ф������ #3��Ǻҷ
			accelaration *= 1.3f;
			if(pl->CurLoadout.HeroItemID == 20254 ) //����Ф������ #3��Ǻҷ
			accelaration *= 1.3f;
