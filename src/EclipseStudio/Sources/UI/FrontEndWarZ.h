...
private:
	...
	void eventRequestPinAccount(r3dScaleformMovie* pMovie, const Scaleform::GFx::Value* args, unsigned argCount);
	void eventSetPinKeyAccount(r3dScaleformMovie* pMovie, const Scaleform::GFx::Value* args, unsigned argCount);
	void eventUnlockPinKeyAccount(r3dScaleformMovie* pMovie, const Scaleform::GFx::Value* args, unsigned argCount);
...
// char create
	...
	int		mStore_BuyQuantity; //BuyQuantity
