	...
	else if ( !_strnicmp( var_name, "mapname", 7 ) )
	{
		...
		if ( currentLocalPlayer )
		{
			...
			case GBGameInfo::MAPID_WZ_AircraftCarrier: 
				sprintf ( result, "WZ_AircraftCarrier (%f, %f, %f)", pos.x, pos.y, pos.z );  
				break;
			case GBGameInfo::MAPID_WZ_Trade_Map: 
				sprintf ( result, "WZ_Trade_Map (%f, %f, %f)", pos.x, pos.y, pos.z );  
				break;

/////////////////////////////////////////

			case GBGameInfo::MAPID_PVP01:
				sprintf ( result, "PVP01 (%f, %f, %f)", pos.x, pos.y, pos.z );  
				break;
			case GBGameInfo::MAPID_PVP02:
				sprintf ( result, "PVP02 (%f, %f, %f)", pos.x, pos.y, pos.z );  
				break;
			case GBGameInfo::MAPID_PVP03:
				sprintf ( result, "PVP03 (%f, %f, %f)", pos.x, pos.y, pos.z );  
				break;
			case GBGameInfo::MAPID_PVP04:
				sprintf ( result, "PVP04 (%f, %f, %f)", pos.x, pos.y, pos.z );  
				break;
			case GBGameInfo::MAPID_PVP05:
				sprintf ( result, "PVP05 (%f, %f, %f)", pos.x, pos.y, pos.z );  
				break;
			case GBGameInfo::MAPID_PVP06:
				sprintf ( result, "PVP06 (%f, %f, %f)", pos.x, pos.y, pos.z );  
				break;
			case GBGameInfo::MAPID_PVP07:
				sprintf ( result, "PVP07 (%f, %f, %f)", pos.x, pos.y, pos.z );  
				break;
			case GBGameInfo::MAPID_PVP08:
				sprintf ( result, "PVP08 (%f, %f, %f)", pos.x, pos.y, pos.z );  
				break;
			case GBGameInfo::MAPID_PVP09:
				sprintf ( result, "PVP09 (%f, %f, %f)", pos.x, pos.y, pos.z );  
				break;
			case GBGameInfo::MAPID_PVP10:
				sprintf ( result, "PVP10 (%f, %f, %f)", pos.x, pos.y, pos.z );  
				break;
			case GBGameInfo::MAPID_PVP11:
				sprintf ( result, "PVP11 (%f, %f, %f)", pos.x, pos.y, pos.z );  
				break;
			case GBGameInfo::MAPID_PVP12:
				sprintf ( result, "PVP12 (%f, %f, %f)", pos.x, pos.y, pos.z );  
				break;
			case GBGameInfo::MAPID_PVP13:
				sprintf ( result, "PVP13 (%f, %f, %f)", pos.x, pos.y, pos.z );  
				break;
			case GBGameInfo::MAPID_PVP14:
				sprintf ( result, "PVP14 (%f, %f, %f)", pos.x, pos.y, pos.z );  
				break;
			case GBGameInfo::MAPID_PVP15:
				sprintf ( result, "PVP15 (%f, %f, %f)", pos.x, pos.y, pos.z );  
				break;
			case GBGameInfo::MAPID_PVP16:
				sprintf ( result, "PVP16 (%f, %f, %f)", pos.x, pos.y, pos.z );  
				break;
			case GBGameInfo::MAPID_PVP17:
				sprintf ( result, "PVP17 (%f, %f, %f)", pos.x, pos.y, pos.z );  
				break;
			case GBGameInfo::MAPID_PVP18:
				sprintf ( result, "PVP18 (%f, %f, %f)", pos.x, pos.y, pos.z );  
				break;
			case GBGameInfo::MAPID_PVP19:
				sprintf ( result, "PVP19 (%f, %f, %f)", pos.x, pos.y, pos.z );  
				break;
			case GBGameInfo::MAPID_PVP20:
				sprintf ( result, "PVP20 (%f, %f, %f)", pos.x, pos.y, pos.z );  
				break;
			case GBGameInfo::MAPID_PVP21:
				sprintf ( result, "PVP21 (%f, %f, %f)", pos.x, pos.y, pos.z );  
				break;
			case GBGameInfo::MAPID_PVP22:
				sprintf ( result, "PVP22 (%f, %f, %f)", pos.x, pos.y, pos.z );  
				break;
			case GBGameInfo::MAPID_PVP23:
				sprintf ( result, "PVP23 (%f, %f, %f)", pos.x, pos.y, pos.z );  
				break;
			case GBGameInfo::MAPID_PVP24:
				sprintf ( result, "PVP24 (%f, %f, %f)", pos.x, pos.y, pos.z );  
				break;
			case GBGameInfo::MAPID_PVP25:
				sprintf ( result, "PVP25 (%f, %f, %f)", pos.x, pos.y, pos.z );  
				break;
