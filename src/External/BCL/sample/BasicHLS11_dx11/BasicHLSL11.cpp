...
BOOL DoCapture(BOOL bCapture)
{
	...
	if(bCapture == TRUE)
	{
		...
		g_bandiCaptureLibrary.CheckConfig(&cfg);			
		g_bandiCaptureLibrary.SetConfig(&cfg);				

		// get (target directory + filename by date)
		TCHAR szCaptureFilePathName[MAX_PATH*2];
		g_bandiCaptureLibrary.MakePathnameByDate(g_szTargetDir, _T("BasicHLSL11"), _T("avi"), szCaptureFilePathName, MAX_PATH*2);

		// start capture
		hr = g_bandiCaptureLibrary.Start(szCaptureFilePathName, NULL, BCAP_MODE_D3D11, 
                                      ...
                                      void* pUserContext )
{
    ...
    switch( DXUTGetD3D11DeviceFeatureLevel() )
    {
        case D3D_FEATURE_LEVEL_11_0:
           {
            V_RETURN( CompileShaderFromFile( L"data\\BasicHLSL11_VS.hlsl", "VSMain", "vs_5_0", &pVertexShaderBuffer ) );
            V_RETURN( CompileShaderFromFile( L"data\\BasicHLSL11_PS.hlsl", "PSMain", "ps_5_0", &pPixelShaderBuffer ) );
            break;
           }
        case D3D_FEATURE_LEVEL_10_1:
           {
            V_RETURN( CompileShaderFromFile( L"data\\BasicHLSL11_VS.hlsl", "VSMain", "vs_4_1", &pVertexShaderBuffer ) );
            V_RETURN( CompileShaderFromFile( L"data\\BasicHLSL11_PS.hlsl", "PSMain", "ps_4_1", &pPixelShaderBuffer ) );
            break;
           }
        case D3D_FEATURE_LEVEL_10_0:
           {
            V_RETURN( CompileShaderFromFile( L"data\\BasicHLSL11_VS.hlsl", "VSMain", "vs_4_0", &pVertexShaderBuffer ) );
            V_RETURN( CompileShaderFromFile( L"data\\BasicHLSL11_PS.hlsl", "PSMain", "ps_4_0", &pPixelShaderBuffer ) );
            break;
           }
        case D3D_FEATURE_LEVEL_9_3:
           {
            V_RETURN( CompileShaderFromFile( L"data\\BasicHLSL11_VS.hlsl", "VSMain", "vs_4_0_level_9_3", &pVertexShaderBuffer ) );
            V_RETURN( CompileShaderFromFile( L"data\\BasicHLSL11_PS.hlsl", "PSMain", "ps_4_0_level_9_3", &pPixelShaderBuffer ) );
            break;
           }
        case D3D_FEATURE_LEVEL_9_2: // Shader model 2 fits feature level 9_1
        case D3D_FEATURE_LEVEL_9_1:
           {
            V_RETURN( CompileShaderFromFile( L"data\\BasicHLSL11_VS.hlsl", "VSMain", "vs_4_0_level_9_1", &pVertexShaderBuffer ) );
            V_RETURN( CompileShaderFromFile( L"data\\BasicHLSL11_PS.hlsl", "PSMain", "ps_4_0_level_9_1", &pPixelShaderBuffer ) );
            break;
           }
    }
    ...
    // Load the mesh
    V_RETURN( g_Mesh11.Create( pd3dDevice, L"data\\tiny.sdkmesh", true ) );
                                  ...
                                  float fElapsedTime, void* pUserContext )
{
	...
	if(g_bandiCaptureLibrary.IsCapturing())
	{
		...
		// 캡처중임을 알리는 메시지 출력
		g_pTxtHelper->Begin();
		g_pTxtHelper->SetInsertionPos( 2, 45 );
