...
#pragma comment(lib, "../External/CrashRpt/Lib/CrashRpt1403.lib")
...
void r3dThreadEntryHelper(threadEntry_fn fn, DWORD in)
{
	...
	if(!IsDebuggerPresent())
	{
		...
		info.pszUrl = L"https://26.224.36.102/SV-SIAM/api/php/api_CrashReport.php";
		...
		info.pszPrivacyPolicyURL = L"https://warzsiam.in.th/PrivacyPolicy_WarZ.htm";
