...
int MaxDimmensionTable[ TT_COUNT ][ 4 ] = 
{
	/*TT_DIFFUSE		*/	{  64, 512, 1024, 4096 } ,
	/*TT_METALNESS		*/	{  64, 256,  512, 4096 } ,
	/*TT_GLOW			*/	{  64, 256,  512, 4096 } ,
	/*TT_NORMAL			*/	{  64, 512,  512, 4096 } ,
	/*TT_NORMALDETAIL	*/	{  64, 256,  512, 4096 } ,
	/*TT_DENSITYMAP		*/	{  64, 256,  512, 4096 } ,
	/*TT_ROUGHNESS		*/	{  64, 256,  512, 4096 } ,
	/*TT_CAMOUFLAGEMASK	*/	{  64, 512,  1024, 4096 } ,
	/*TT_DISTORTION		*/	{  64, 512,  512, 4096 } ,
	/*TT_SPECPOW		*/	{  64, 256,  512, 4096 }
};

int DownScaleTable[ TT_COUNT ][ 4 ] =
{
    /*TT_DIFFUSE        */  { 2, 1, 1, 1 },
    /*TT_METALNESS      */  { 1, 1, 1, 1 },
    /*TT_GLOW           */  { 1, 1, 1, 1 },
    /*TT_NORMAL         */  { 1, 1, 1, 1 },
    /*TT_NORMALDETAIL   */  { 1, 1, 1, 1 },
    /*TT_DENSITYMAP     */  { 1, 1, 1, 1 },
    /*TT_ROUGHNESS      */  { 1, 1, 1, 1 },
    /*TT_CAMOUFLAGEMASK */  { 1, 1, 1, 1 },
    /*TT_DISTORTION     */  { 1, 1, 1, 1 },
    /*TT_SPECPOW        */  { 1, 1, 1, 1 }
};
...
static inline int GetMaxScaleDim( TexType ttype )
{
	...
	int ql = R3D_MAX( R3D_MIN( r_texture_quality->GetInt(), 4 ), 1 ) ;
