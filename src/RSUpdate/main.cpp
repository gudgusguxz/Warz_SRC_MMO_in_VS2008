...
static void drawProgressBar(CUpdater& updater)
{
  ...
  g_font3->PrintF( 9, base_y+15, r3dColor(170, 170, 170), "SiamNewByManut v%s%s", UPDATER_VERSION,UPDATER_VERSION_SUFFIX);
...
static void drawLoginButtons(CUpdater& updater)
{
  ...
  if(drawUrl(492, 445, "Forgot Password ?")) {
    ShellExecute(NULL, "open", "https://www.facebook.com/warzsiam.in.th/", "", NULL, SW_SHOW);
  ...
  if(insideRect(g_rRegisterNewBtn, g_mx, g_my)) 
  {
    ...
    if(g_mb) {
      ...
      //ShellExecute(NULL, "open", "https://docs.google.com/document/d/1di5ErX7Fl868As35DHOQN2B9Qq4tGXTdHvhPyNJXuaI/edit?usp=sharing", "", NULL, SW_SHOW);
      return;
    }
  }
