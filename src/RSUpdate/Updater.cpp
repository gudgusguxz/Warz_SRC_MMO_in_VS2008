...
void CUpdater::ProcessLoginResults()
{
    switch(gUserProfile.loginAnswerCode) 
    {
      ...
      case CLoginHelper::ZFL_BANALLBanned: //BanAll
      {
        loginErrMsg_ = "Your Account - Computer has been permanently banned";
        MessageBox(NULL, "Banned: This account has been investigated and permanently closed for violations of the Terms of Use", "Login", MB_OK | MB_ICONSTOP);
        break;
      }
