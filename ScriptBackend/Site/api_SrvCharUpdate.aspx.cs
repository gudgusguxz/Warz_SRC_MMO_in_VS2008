...
public partial class api_SrvCharUpdate : WOApiWebPage
{
    ...
    void UpdateCharStatus()
    {
        ...
        sqcmd.Parameters.AddWithValue("@in_GamePoints", web.Param("gC"));
        ...
        sqcmd.Parameters.AddWithValue("@in_NoDrop", web.Param("n")); //NARA::Nodrop
    ...
    protected override void Execute()
    {
        if (Request.UserHostAddress != "127.0.0.1" &&
            Request.UserHostAddress != "26.224.36.102")
        {
            throw new ApiExitException("bad ip address");
        }
