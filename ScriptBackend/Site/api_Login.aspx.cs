...
public partial class api_Login : WOApiWebPage
{
    ...
    void SendLockEmail(string email, string countryIP, string token)
    {
        ...
        string url = "http://26.224.36.102/SV-SIAM/api/api_AccUnlock.aspx?token=" + token;
        ...
        /*try
        {
            ...
            MailMessage mail = new MailMessage("support@127.0.0.1.com", email);
            SmtpClient client = new SmtpClient();
            client.DeliveryMethod = SmtpDeliveryMethod.Network;
            client.Host = "smtp.mandrillapp.com";
            client.Port = 25;
    ...
    protected override void Execute()
    {
        ...
        string Identifier = web.Param("Identifier");
        ...
        //sqcmd.Parameters.AddWithValue("@in_BiosNumber", Identifier);
