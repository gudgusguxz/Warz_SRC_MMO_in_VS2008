...
public partial class api_GetProfile1 : WOApiWebPage
{
    void AddChars(ref StringBuilder xml, bool FromServer)
    {
        ...
        while (reader.Read())
        {
            ...
            xml.Append(xml_attr("GamertagColor", reader["GamertagColor"]));
    ...
    protected override void Execute()
    {
        ...
        xml.Append(xml_attr("BadPin", reader["BadPinCount"]));
        xml.Append(xml_attr("PinAcc", reader["ActivePinAcc"]));
        xml.Append(xml_attr("PinStatus", reader["LoginPinStatus"]));
